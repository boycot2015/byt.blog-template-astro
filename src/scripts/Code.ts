...
export default () => {
  // Pre 滚动条======
  document.querySelectorAll("section.byt-code-box>pre.astro-code").forEach((i: any) => {
    OverlayScrollbars(i, { scrollbars: { autoHide: "leave", autoHideDelay: 500, autoHideSuspend: false } });
  });
  // Pre Code 代码复制功能======
  document.querySelectorAll("section.byt-code-box>span.byt-code-copy").forEach((i: any) => {
    i.vhTimer = null;
